...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-home-home-module"], {
  ...
  /***/
  function srcAppFeaturesHomeHomeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppFeaturesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HomeComponent_app_error_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(route, utenteService, pagamentoService, loaderService, contoService, utentiStore, contiStore) {
        ...
        value: function ngOnInit() {
          ...
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (params) {
            ...
            if (_this.commerciante$.value && _this.commerciante$.value.id) {
              return _this.commerciante$;
            } else {
              return _this.contoService.getConto(params.idConto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(function (conto) {
                _this.contiStore.add(src_app_core_constants_utente_type_enum__WEBPACK_IMPORTED_MODULE_3__["UtenteType"].commerciante, conto);

                return _this.utenteService.getUtenteNoSecurity(conto.id);
              }));
            }
          })).subscribe({
  ...
  function srcAppFeaturesHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"], src_app_core_core_module__WEBPACK_IMPORTED_MODULE_5__["CoreModule"], src_app_shared__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]]
    });
